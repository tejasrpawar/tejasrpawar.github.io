      ...
      >
        ...
        >
          <div className="flex min-h-screen w-full flex-col font-[family-name:var(--font-geist)]">
            ...
            <div
              aria-hidden="true"
              className="material-edge pointer-events-none fixed inset-x-0 top-0 z-10 h-16 bg-white/60 [-webkit-mask-image:linear-gradient(to_bottom,black,transparent)] [mask-image:linear-gradient(to_bottom,black,transparent)] dark:bg-zinc-950/60"
            />
